...
We investigated three possible sources of bias: total number of pages of ethnography, year of publication of each document, and the presence or absence of a female author/co-author for each document. We found evidence for bias in reporting of evidence for 9 of 105 [get new value] variables based on year of publication only. There was no convincing evidence of bias in any variable based on the total number of pages of ethnography or ethographer gender. Results now reported.
...
This is a good idea. We now include a short section on our "status" variable, and what distinguishes leadership records with evidence for social status from those without such evidence. We found xx, yy.
...
OR, better idea (?), use LASSO technique from paper one, to identify words predictive of high status present or not
-->
...
We added a few additional details in the methods section on the eHRAF and ethnographic sample and now more clearly direct readers to the original publication from which the database was built, which includes additional details. 

We also include additional details in the results and supplementary information on the corpus of ethnographic documents which provide the sample of ethnographic paragraphs. NEED TO DO. 
...
In the methods section we now include a description of all levels of our *group structure* coding to clearly explain this coding scheme. We coded supracommunity leaders in cases when the "group" involves leadership beyond the community level and across multiple residential communities, such as regional political leaders, chiefs in complex chiefdoms, kings, and state-level leaders. This termonology was vaugely inspiried by Murdock and Provost's (1971) Political Integration Scale which codes the political integration at the society-level as either automonous local communities, or having one, two, or three levels of juridictional hiuerarchy "above the community"; i.e., if political authority is exclusive to a local village headman, the group would be coded as "autonomous" but if the village and headman are under authority of a chief from a seperate community, the group would be coded as "one level above community", and so forth. 
...
This statement in the introduction is intended to apply across disciplines focused on leadership dynamics and not specifically apply to the methods of the current study. The reviewer brings up a well-recieved point, however. Any work in developmental psychology on social hierarchy adn leadership would not be subjec to this critique. We have not rephrased this claim to better fit with our objectives and outcomes here. 
...
<!-- ADDED SOME DISCUSSION IN INTRO. NEED TO FINISH -->
...
We now discuss sex-differences in community and political leadership, and refernce in greater deatils (albeit breif) the universal male bias in community leadership in the introuction and cite these works. 
...
The reviewer brings up an important, i.e., the conceptual and operational overlap in many study variables, and specifically between various qualities and benifits. This is partly a consequence of our methodology, given the coding of qualities was purely driven by the ethngoraphic record whereas our coding of costs and benefits was sketched out a priori, based on evolutionary theory. 
...
We now discuss these disctintions in more detail in the methods and limitations sections.
