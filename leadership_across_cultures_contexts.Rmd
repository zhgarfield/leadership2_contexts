...
The leader quality cluster analysis (Figure \@ref(fig:cluster)A) idenfitified two top-level clusters. Within each top-level cluster we identify two interpretable and generally strongly supported sub-clusters which are annotated with text. Within the first top-level cluster, we identify a dominant/shaman cluster, which suggests a strong link between dominance-based leadership (e.g., *Authority*, *Aggressiveness*, *Feared*) and shamanism (e.g., *Supernatural*, *Artistic performance*). The second sub-cluster includes qualities of leaders related to material, social, and reproductive success. 
