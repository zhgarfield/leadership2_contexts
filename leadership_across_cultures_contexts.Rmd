...
This theoretical development ultimately produced perspectives emphasizing that organizations become larger, increasing hierarchical, adm more complex leaders... (3078 Bass) -- INTELLIGENCE and COGNITIVE COMPLEXITY IN LARGER INSTITUIONS
...
Institutionalized leadership positions are also often, if not universally, associated with increased social status. The causal relationship between high social status and community or political leadership is complex and likely to be context-specific and bi-directional, but is widely associated with numerous social, material, and reproductive benefits.  

Leaders and high-status individuals are also more likely to be the recipients of social support and material benefits in times of need. Across many industries and organizations leadership positions are associated with increased pay. High social status, material wealth, and leadership status are also viewed as sexually attractive, particularly among women [@buss_strategies_2006].
...
The most common *functions* leaders serve, which are documented in over 70% of cultures, are resolving conflicts, providing various social functions, providing counsel or direction in follower's affairs, and organizing various cooperative activities. Leaders also commonly serve as a representative in inter-group interactions, manage the distribution of resources, and provide context-specific leadership such as military command and in providing ritual services. In about half of the cultures sampled here leaders punish other group members and manage economic systems. Notable infrequent functions identified here include controlling group movement and migrations. 

The most common *qualities* of leaders are being of high social status (documented in over 90% of cultures), being experienced or accomplished, and being described as knowledgeable or intelligent (documented in approximately 80% of cultures). Also, in about 60% of the cultures sampled here leaders were wealthy, nepotistic, possessed supernatural qualities, were generous, and maintained strong authority over followers. Notable infrequent qualities of leaders in these data include charisma and fairness. 
