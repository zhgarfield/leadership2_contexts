...
```{r qualfuncvars, echo=FALSE, message=F, warning=FALSE, eval=F}
library(readr)
...
```{r costbenefitvars, echo=FALSE, message=F, warning=FALSE, eval=F}
library(readr)
