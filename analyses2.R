...
cost_benefit_dict <- c(
  ...
  leader.benefits_FesourceFood = 'Food benefit',
  ...
  leader.costs_FitnessCosts = 'Inclusive fitness cost',
  leader.costs_RiskHarmConflict = 'Increased risk of harm',
  leader.costs_Other = 'Misc. non-material cost',
  leader.costs_ResourceFoodCost = 'Food cost',
  leader.costs_ResourcesOther = 'Loss of material resources',
  leader.costs_SocialStatus = 'Reduced social status',
  ...
  follower.costs_SocialStatus = 'Reduced social status',
